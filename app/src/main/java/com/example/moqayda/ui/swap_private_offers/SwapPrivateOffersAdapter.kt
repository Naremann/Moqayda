...
class SwapPrivateOffersAdapter(var swapPrivateOffers: List<PrivateProductOwnerByIdResponse?>?= mutableListOf()) : RecyclerView.Adapter<SwapPrivateOffersAdapter.SwapPrivateOffersViewHolder>() {

      class SwapPrivateOffersViewHolder(private val viewBinding: SwapPrivateOffersItemBinding) : RecyclerView.ViewHolder(viewBinding.root) {

         fun bind(swapPrivateOffers: PrivateProductOwnerByIdResponse) {
